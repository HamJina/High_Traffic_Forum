package high.traffic.forum.comment.entity;
...
public class CommentPath {
    ...
    private static final int DEPTH_CHUNK_SIZE = 5; // 한 depth 당 5개의 문자열로 표현한다
    private static final int MAX_DEPTH = 5; // 최대 5 depth 까지 표현
    ...
    public CommentPath createChildCommentPath(String descendantsTopPath) {
        if (descendantsTopPath == null) { // 처음 생성되는 상황

package high.traffic.forum.comment.api;
...
public class CommentApiTest {
  ...
  /*      commentId=193585252504379392
        commentId=193585254639280128
        commentId=193585254739943424*/
    }
    ...
    void read() {
        CommentResponse response = restClient.get()
                .uri("/v1/comments/{commentId}", 193585252504379392L)
                .retrieve()
                .body(CommentResponse.class);
    ...
    void delete() {
        restClient.delete()
                .uri("/v1/comments/{commentId}", 193585254739943424L)
                .retrieve();
    }
